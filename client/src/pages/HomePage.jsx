  ...
  return (
    <div className="home-container position-relative text-white">
      ...
      <Container className="mt-5 pt-5 text-center">
        ...
        <p className="lead">This week: Reduce plastic usage! Share your story 🌍</p>
      </Container>
      ...
      <Container className="about-section mt-5 p-4">
        <h4>About Us</h4>
        <p>
          Our platform empowers students and schools to share 60-second sustainability stories —
          from recycling tips to eco initiatives. Join the movement to make climate literacy fun and impactful!
        </p>
      </Container>
